...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("always-publish-not-ready-address", "Always publish also not ready addresses for headless services (optional)").BoolVar(&cfg.AlwaysPublishNotReadyAddresses)
